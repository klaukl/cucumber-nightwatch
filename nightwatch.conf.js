...
const {
  ...
  ScreenOrientation,
  IosDeviceName,
} = require('@applitools/eyes-nightwatch')
...
module.exports = {
  ...
  //   //batch: { id: process.env.TESTID, name: `${process.env.PROJECT}:${process.env.TESTID}` }, // TODO: add batch id
  //   enableEyesLogs: true, // this will enable the SDK's logs and write them to the console
  //   useVisualGrid: true, // this will utilize the Ultrafast grid
  //   setForceFullPageScreenshot: true,
  //   concurrency: 10,
  //   baselineBranchName: 'develop',
  //   branchName: process.env.CIRCLE_BRANCH || 'local-testing',
  //   layoutBreakpoints:true,
  //   browsersInfo: [
  //     { name: BrowserType.CHROME, width: 1366, height: 768 },
  //     { name: BrowserType.EDGE_CHROMIUM, width: 1366, height: 768 },
  //     { name: BrowserType.SAFARI, width: 1366, height: 768 },
  //     { chromeEmulationInfo: { deviceName: DeviceName.Galaxy_S10, screenOrientation: ScreenOrientation.PORTRAIT } },
  //     { iosDeviceInfo: { deviceName: IosDeviceName.iPhone_11_Pro_Max, screenOrientation: ScreenOrientation.PORTRAIT, iosVersion: 'latest' } } //safari on ios devices
  //   ],
  // },
}
